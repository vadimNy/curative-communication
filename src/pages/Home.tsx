        ...
        <div className="text-center max-w-4xl mx-auto animate-fadeIn">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3 mb-6 relative z-10">
            ...
            <div className="inline-flex items-center space-x-2 bg-sky-500/10 text-sky-700 px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase border border-sky-500/20">
              ...
              <span>NYC Department of Education Approved Vendor</span>
            </div>
          </div>

          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-slate-900 leading-tight relative z-10">
            Premium Remote <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-sky-600">Speech Therapy</span> from Home
          </h1>
          
          <p className="mt-6 text-lg sm:text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed relative z-10">
            Evidence-based, clinically validated speech and language intervention tailored for pediatric developmental goals and adult cognitive-linguistic recovery.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              title: "Certified SLPs",
              desc: "Licensed NY Clinicians with Certificate of Clinical Competence (CCC-SLP) from the American Speech-Language-Hearing Association (ASHA)."
            }
          ].map((item, idx) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative">
              ...
              <div className="relative bg-teal-600/5 border border-teal-500/10 p-4 rounded-3xl w-72 h-80 sm:w-80 sm:h-96 flex flex-col justify-between items-center text-center">
                <div className="my-auto">
                  <Landmark className="h-12 w-12 text-teal-600 mx-auto mb-4" />
                  <span className="block text-2xl font-bold text-slate-900">NYC DOE Vendor</span>
                  <span className="block text-sm font-semibold text-teal-600 tracking-wider uppercase mt-1">Authorized Care</span>
                  <span className="block text-xs text-slate-400 mt-2">New York City Department of Education Approved</span>
                </div>
                <div className="w-full bg-white/70 backdrop-blur p-4 rounded-2xl border border-slate-100">
                  <span className="text-xs font-bold text-slate-500 uppercase tracking-widest block">Licensure</span>
                  <span className="text-xs font-semibold text-slate-700">Curative Communication LLC</span>
                </div>
              </div>
            </div>
          </div>
